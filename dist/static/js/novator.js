...
document.addEventListener('DOMContentLoaded', function () {
    ...
    newRangeSlider.onChange = function (min, max) {
        document.querySelector('.max_value input').value = Number(max).toLocaleString('ru-RU')
        document.querySelector('.min_value input').value = Number(min).toLocaleString('ru-RU')
    ...
    document.querySelector('.business-helper__form').addEventListener('submit', function(e){
        ...
        document.querySelector('.business-helper__body').classList.add('wait_response')
    })
